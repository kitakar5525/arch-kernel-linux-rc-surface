...
pkgbase=linux-rc50-surface       # Build kernel with a different name
_srcver=5.0-rc6
pkgver=${_srcver//-/.}
pkgrel=2
arch=(x86_64)
...
source=(
  ...
  '4416-s2idle-02-5525-nvme-add-quirk-to-not-call-disable-function-when-suspending-for-powersaving-500.patch'
